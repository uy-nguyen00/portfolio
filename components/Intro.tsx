...
import PortfolioImage from "@/public/UyNguyen_Portfolio.png";
...
export default function () {
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Uy Nguyen.</span> I'm a{" "}
        <span className="font-bold">full-stack developer</span> with{" "}
        <span className="font-bold">2 years</span> of experience. I enjoy
        building <span className="italic">sites & apps</span>. My focus is{" "}
        <span className="underline">Node.js and PHP</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/cao-thanh-uy-nguyen/"
          target="_blank"
        >
          <BsLinkedin/>
        </a>
        ...
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15]
            ...
            dark:bg-white/10 dark:text-white/60"
          href="https://github.com/uy-nguyen00"
          target="_blank"
        >
          <FaGithubSquare/>
        </a>
